                    ...
                    <div class="row">
                        ...
                        <div class="col container2 d-flex justify-content-end">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="contact.php" class="nav-link"><strong>Contact</strong></a>
                                </li>
    ...
    <div class="container-fluid">
        <div class="row p-5 m-5">
            <div class="col-6 p-5 text-center">
                <h1 class="display-5">Contact Us <img src="images/telephone.png" alt="" width="40" class="pb-2"></h1>
                <p class="lead pt-4">Need to get in touch with us? Either fill out the form
                    with your enquiry or Call us @(876) 784-2385, (876)682-9003
                </p>
            </div>
            <div class="col-6">
                <form action="">
                    ...
                    <div class="mb-3">
                        <label for="text" class="form-label">What can we help you with?</label>
                        <textarea name="" id="text" cols="10" rows="5" class="form-control"></textarea>
                    </div>
